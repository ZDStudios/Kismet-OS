...
KISMET_PACKAGES="plasma-desktop plasma-workspace-wayland sddm sddm-theme-breeze konsole dolphin kate plasma-discover kde-config-sddm kde-config-gtk-style kde-style-breeze python3-flask python3-psutil python3-requests python3-pip python3-venv python3-watchdog python3-pydantic python3-inotify curl wget git tmux zsh jq"
