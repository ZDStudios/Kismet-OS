...
KISMET_PACKAGES="gnome-session gnome-shell gdm3 gnome-terminal nautilus gnome-software gnome-system-monitor gnome-calculator gnome-calendar gnome-contacts gnome-text-editor gnome-disks gnome-screenshot gnome-clocks gnome-weather cheese simple-scan yaru-gtk-theme yaru-qt-theme papirus-icon-theme python3-flask python3-psutil python3-requests python3-pip python3-venv python3-watchdog python3-pydantic python3-inotify curl wget git tmux zsh jq wine64 winetricks lutris winbind fonts-wine"
